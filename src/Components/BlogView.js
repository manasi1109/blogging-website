...
{context.stater ? 
<Popup
   trigger={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white absolute bottom-0 my-2 right-7 cursor-pointer">
...
{context.stater ? <Popup
   trigger={ <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white absolute bottom-0 my-2 cursor-pointer">
          ...
          No
              ...
              {/* <p>{Bloge.summary}</p>   */}
                ...
                <div className='border-dotted border-t-2 border-gray-400'></div>
                 <div className=' py-2 '>
                 <div className=''>
                {isClick? <h1 className='text-sm'>Liked the blog?<img onClick={()=>{myHeart()}} src={heart} alt="heart" className="w-11 h-11 absolute z-10 -mt-1 ml-1"/></h1> : <h1 className='text-sm'>Liked the blog?<svg onClick={()=>{myHeart()}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-red-500 font-extrabold mt-1.5 ml-3 absolute z-10 align-middle">
